...
const OrderFailedPage: React.FC<OrderFailedPageProps> = ({ onNavigate }) => {
        ...
        >
          <div className="flex">
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="text-red-400 text-sm" style={{ fontFamily: 'Poppins', fontWeight: 500, fontSize: '14px', lineHeight: '100%', letterSpacing: '0%' }}>
                {orderDetails.status}
              </div>
            </div>
          </div>
